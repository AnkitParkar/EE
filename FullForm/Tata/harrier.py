...
def select_dealer():
    ...
    try:
        ...
        type=sel.first_selected_option.text.split('-')[1].strip()
        print(type)
        time.sleep(3)
        ...
        if error_type==1:
            Error_log(car,None,None,None,'Car Type Issue',None,None,driver.current_url,json_data['error_csv_path'])
        elif error_type==2:
            Error_log(car,type,None,None,'Car Variant Issue',None,None,driver.current_url,json_data['error_csv_path'])
        elif error_type==3:
            Error_log(car,type,variant,None,'Colour issue',None,None,driver.current_url,json_data['error_csv_path'])
...
def harrier_start():
    ...
    try:
        driver.get(json_data['harrier_url'])
